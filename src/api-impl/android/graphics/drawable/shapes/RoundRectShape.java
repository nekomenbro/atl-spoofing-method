...
public class RoundRectShape extends RectShape {
	...
	public void getOutline(Outline outline) {
		if (mInnerRect != null)
			return; // have a hole, can't produce valid outline
	...
	public boolean equals(Object o) {
		...
		return Arrays.equals(mOuterRadii, that.mOuterRadii) && Objects.equals(mInset, that.mInset) && Arrays.equals(mInnerRadii, that.mInnerRadii) && Objects.equals(mInnerRect, that.mInnerRect) && Objects.equals(mPath, that.mPath);
	}
