...
public class PathShape extends Shape {
	...
	public boolean equals(Object o) {
		...
		return Float.compare(pathShape.mStdWidth, mStdWidth) == 0 && Float.compare(pathShape.mStdHeight, mStdHeight) == 0 && Float.compare(pathShape.mScaleX, mScaleX) == 0 && Float.compare(pathShape.mScaleY, mScaleY) == 0
