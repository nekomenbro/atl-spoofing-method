...
public class Patterns {
	...
	static final String IANA_TOP_LEVEL_DOMAINS =
	    ...
	    + "|accountants|aco|actor|ads|adult|aeg|aero|etna|afl|africa|agakhan|agency|aig|airbus"
	 ...
	 * @hide
	 */
	public static final Pattern AUTOLINK_EMAIL_ADDRESS = Pattern.compile("(" + WORD_BOUNDARY + "(?:" + EMAIL_ADDRESS_LOCAL_PART + "@" + EMAIL_ADDRESS_DOMAIN + ")" + WORD_BOUNDARY + ")");
