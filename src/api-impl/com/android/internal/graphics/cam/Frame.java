...
public final class Frame {
	...
	public static Frame make(@NonNull float[] whitepoint, float adaptingLuminance,
		...
		float c = (f >= 0.9) ? MathUtils.lerp(0.59f, 0.69f, ((f - 0.9f) * 10.0f)) : MathUtils.lerp(0.525f, 0.59f, ((f - 0.8f) * 10.0f));
		...
		float k4 = k * k * k * k;
		float k4F = 1.0f - k4;
		float fl = (k4 * adaptingLuminance) + (0.1f * k4F * k4F * (float)Math.cbrt(5.0 * adaptingLuminance));
